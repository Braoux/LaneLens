...
app.innerHTML = `
  ...
  <footer><span>LANELENS</span><button class="feedback-link" id="report-bug" type="button">${t('feedback.openBug')}</button><span id="health" role="status">${t('health.checking')}</span></footer>
